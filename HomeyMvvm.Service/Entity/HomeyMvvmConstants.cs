...
namespace HomeyMvvm.Service.Entity
{
    public struct HomeyMvvmConstants
    {
        ...
        public static string DefaultConfigPath { get { return (Utility.getAbsolutePath("Config", "HomeyMvvm.cfg", true)); } }
