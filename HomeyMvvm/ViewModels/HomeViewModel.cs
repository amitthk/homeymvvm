...
using HomeyMvvm.Common.Messaging;
using System;
...
namespace HomeyMvvm.ViewModels
{
     public class HomeViewModel: BaseViewModel
    {
        ...
        HomeyMvvm.Service.ITodoService _todoServiceClient;
        ...
        {
            _eventAggregator.Publish<HomeyMvvm.Views.NavMessage>(new Views.NavMessage(new Views.TodoDetails(), SelectedTodo));
        }
